...
void Widget::setSlot()
{
    ...
    connect(user_manage,SIGNAL(WriteUsrInfo(QString,QString,QString,QString,int)),this,SLOT(Add_User_Button_Clicked(QString,QString,QString,QString,int)));
    connect(user_manage,SIGNAL(DeleteUserInfo(QString)),this,SLOT(Delete_User_Button_Clicked(QString)));
}
...
void Widget::Add_User_Button_Clicked(QString uid, QString name, QString gen, QString age, int rcds){
    qDebug()<<"添加用户写卡";
