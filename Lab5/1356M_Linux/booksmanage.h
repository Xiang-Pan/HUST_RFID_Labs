...
#define Table_Column_BOOKS 7//表格列数

enum Button_Index_Books{Add_Books = 0, Delete_Books, Updata_Books, Select_Books};//读卡、添加按钮、删除按钮、更新按钮、搜索按钮
enum Edit_Index_Books{ID_Books = 0, Name_Books, Author_Books, PublishingHouse_Books, Count_Books, Residue_Books,Borrow_Days};//编号、书名、作者、出版社、总数、剩余
