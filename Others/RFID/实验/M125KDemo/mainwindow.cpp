    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(serialPort, SIGNAL(error(QSerialPort::SerialPortError)), this, SLOT(handleError(QSerialPort::SerialPortError)));//收到串口错误信息
...
{    
    ...
    {
        QString tagId = CharStringtoHexString(tr(" "),data.data(),data.length());//获取标签ID
