...
#define Table_Column_BORROW_RETURN 7//表格列数
...
public:
    ...
    void checkReturnDate(QString userID);//检查该用户是否有快逾期的书籍
    QString last_notification_ID;
...
signals:
    void set_record(QString userID, QString bookID);
    void cycle();//循环读取卡号
